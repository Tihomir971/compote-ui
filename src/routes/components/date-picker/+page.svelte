...
<div class="max-w-4xl space-y-5 *:rounded-xl *:border *:border-surface-3 *:bg-surface-1 *:p-4">
	<section>
		...
		<div class="flex flex-col gap-4">
			<DatePicker label="Pick a date" bind:value />
	...
	<section>
		...
		<p class="mb-3 text-sm text-ink-dim">
			Calendar popup includes a time input. Stays open after date selection.
		</p>
		<div class="flex flex-col gap-4">
	...
	<section>
		...
		<p class="mb-3 text-sm text-ink-dim">Today to +3 months.</p>
		<div class="flex flex-col gap-4">
			<DatePicker label="Date" min={minDate} max={maxDate} bind:value={minMaxValue} />
			<p class="text-sm text-ink-dim">
	...
	<section>
		...
		<div class="flex flex-col gap-4">
			<DatePicker label="Weekday" isDateUnavailable={isWeekend} bind:value />
		</div>
	</section>
	...
	<section>
		...
		<div class="flex flex-col gap-4">
			<DatePicker label="Date" value={new CalendarDate(2025, 6, 15)} />
		</div>
	</section>
	...
	<section>
		...
		<div class="flex flex-col gap-4">
			<DatePicker label="Date" invalid bind:value={invalidValue} />
		</div>
	</section>
	...
	<section>
		...
		<div class="flex flex-col gap-4">
			<DatePicker label="Pick a date" disabled />
		</div>
	</section>
</div>
